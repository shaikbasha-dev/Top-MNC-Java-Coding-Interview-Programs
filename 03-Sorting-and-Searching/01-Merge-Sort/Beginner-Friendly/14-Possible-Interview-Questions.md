...
## 1. What is the main idea of Merge Sort?

**Answer:** Merge Sort is a divide-and-conquer sorting algorithm that repeatedly divides an array into smaller halves, sorts the halves, and merges the sorted halves.
