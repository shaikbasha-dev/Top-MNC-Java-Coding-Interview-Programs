...
## 1. What is the main idea of Find the First and Last Occurrence of a Target?

**Answer:** Given a sorted array that may contain duplicate values, find the first and last index at which a target value occurs.
