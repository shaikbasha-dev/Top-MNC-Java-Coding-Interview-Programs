...
## 1. What is the main idea of Search in a Rotated Sorted Array?

**Answer:** A rotated sorted array is a sorted array shifted around a pivot. The task is to find a target efficiently by exploiting the fact that at least one half remains sorted.
