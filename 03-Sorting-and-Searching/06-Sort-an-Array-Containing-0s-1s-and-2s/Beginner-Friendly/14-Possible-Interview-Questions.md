...
## 1. What is the main idea of Sort an Array Containing 0s, 1s and 2s?

**Answer:** This problem sorts an array containing only 0, 1 and 2 without using a general comparison sort. The Dutch National Flag algorithm solves it in one pass.
