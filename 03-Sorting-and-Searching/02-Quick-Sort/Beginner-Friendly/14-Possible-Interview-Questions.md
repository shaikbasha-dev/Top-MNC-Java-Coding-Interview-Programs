...
## 1. What is the main idea of Quick Sort?

**Answer:** Quick Sort is a divide-and-conquer sorting algorithm that selects a pivot, partitions the array around the pivot, and recursively sorts the two partitions.
