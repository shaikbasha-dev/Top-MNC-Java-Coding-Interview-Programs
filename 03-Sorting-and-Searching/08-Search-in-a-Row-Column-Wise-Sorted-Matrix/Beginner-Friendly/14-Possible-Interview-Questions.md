...
## 1. What is the main idea of Search in a Row/Column-Wise Sorted Matrix?

**Answer:** In a matrix where every row and every column is sorted in ascending order, a target can be searched efficiently by starting from the top-right corner.
